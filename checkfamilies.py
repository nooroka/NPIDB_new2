...
file4 = open("interaction_mode_families.txt","w")
list1 = []
list2 = []
...
for line in fileuni:
    if "INSERT INTO `b_pfam_struct_types` VALUES" in line:
        ...
        if len(lineintmode[1]) == 3: #обычные файлы
            #file1.write(str(lineintmode[1][0][1:])+"\t"+str(lineintmode[2])[1:-1]+"\t"+str(lineintmode[5][1:-1])+"\t"+str(lineintmode[6][1:-1])+"\n")#тут цепь и idшник, и сам uniprot (9) и interaction mode (6)
            ...
            file4.write(str(a1.strip())+" "+str(lineintmode[9][1:-1])+"_"+str(lineintmode[10])+"-"+str(lineintmode[11])+" "+str(lineintmode[5][1:-1])+"\n")
            ...
            file4.write(str(a2.strip())+" "+str(lineintmode[9][1:-1])+"_"+str(lineintmode[10])+"-"+str(lineintmode[11])+" "+str(lineintmode[5][1:-1])+"\n")
